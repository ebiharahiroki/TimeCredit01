        ...
        <th class="flex gap-3 px-6 py-4 font-normal text-gray-1000">
          <div class="relative h-10 w-10">
            <div class="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
              <span class="font-semibold title-font text-gray-900">{{ $hour->month->month }}</span>
            </div>
          </div>
          <div class="text-sm">
            <div class="font-medium text-gray-600">{{ $hour->year->year }}</div>
          </div>
        </th>
        <td class="px-6 py-4">{{ $hour->amount }}時間</td>
        <td class="px-6 py-4">{{ $hour->target_value }}時間</td>
        <td class="px-6 py-4">{{ $hour->total_cost }}円</td>
        <td class="px-6 py-4">
