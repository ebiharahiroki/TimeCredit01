            ...
            <div class="flex basis-3/5 bg-white rounded-lg shadow-xl m-4">
                <div class="mx-auto my-5 px-3 w-80">
                    <form action="/hours/store" method="POST">
                        @csrf
                        <div class="Year py-1">
                            <select name="hour[yearId]" class="text-md px-3 py-2 rounded-lg 
                        ...
                        <div class="Month py-1">
                            <select name="hour[monthId]" class="text-md px-3 py-2 rounded-lg w-full bg-white border-2 border-gray-300 placeholder-gray-600 shadow-md focus:outline-none focus:border-gray-600 focus:placeholder-gray-500 focus:bg-white">
                        ...
                        <div class="py-1">
                            ...
                            name="hour[utilityCost]" class="text-md px-3 py-2 rounded-lg
                            w-full bg-white border-2 border-gray-300 placeholder-gray-600
                            shadow-md focus:border-gray-600"
                            value="{{ old('hour.utilityCost') }}"/>
                        ...
                        <div class="py-1">
                            ...
                            name="hour[foodCost]" class="text-md px-3 py-2 rounded-lg
                            w-full bg-white border-2 border-gray-300 placeholder-gray-600
                            shadow-md focus:border-gray-600"
                            value="{{ old('hour.foodCost') }}"/>
                        ...
                        <div class="py-1">
                            ...
                            name="hour[phoneCost]" class="text-md px-3 py-2 rounded-lg
                            w-full bg-white border-2 border-gray-300 placeholder-gray-600
                            shadow-md focus:border-gray-600"
                            value="{{ old('hour.phoneCost') }}"/>
                        ...
                        <div class="py-1">
                            ...
                            name="hour[otherCost]" class="text-md px-3 py-2 rounded-lg
                            w-full bg-white border-2 border-gray-300 placeholder-gray-600
                            shadow-md focus:border-gray-600"
                            value="{{ old('hour.otherCost') }}"/>
                        ...
                        <div class="py-1">
                            ...
                            name="hour[hourlyWage]" class="text-md px-3 py-2 rounded-lg
                            w-full bg-white border-2 border-gray-300 placeholder-gray-600
                            shadow-md focus:border-gray-600"
                            value="{{ old('hour.hourlyWage') }}"/>
