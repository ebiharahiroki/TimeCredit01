                            ...
                            <form action="/hours/store" method="POST">
                                ...
                                <div class="mx-auto max-w-lg ">
                                    ...
                                    <div class="target_value py-1">
                                        ...
                                        <input placeholder="＋αで欲しい自由時間" type="text" x-model="target_value" 
                                        name="hour[target_value]" class="text-md block px-3 py-2 rounded-lg w-full bg-white border-2 border-gray-300 placeholder-gray-600 shadow-md focus:placeholder-gray-500 focus:bg-white focus:border-gray-600 focus:outline-none" value="{{ old('hour.target_value') }}"/>
                                    ...
                                    <div class="py-1">
                                        ...
                                        <input placeholder="家賃" type="text" x-model="rent" name="hour[rent]" class="text-md block px-3 py-2 rounded-lg w-full bg-white border-2 border-gray-300 placeholder-gray-600 shadow-md focus:placeholder-gray-500 focus:bg-white focus:border-gray-600 focus:outline-none" value="{{ old('hour.rent') }}"/>
